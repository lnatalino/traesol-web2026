// src/app/(dev)/email-preview/invitacion-operativo/page.tsx
// Preview del email de invitación a operativo

import { redirect } from "next/navigation";

export const dynamic = "force-dynamic";

export default function InvitacionOperativoPreview() {
  ...
  // Mock data
  const voluntario = { nombre: "María", apellido: "González" };
  const operativo = {
    nombre: "Operativo Dental Comunitario",
    ubicacion: "Centro Comunitario Los Álamos, Temuco",
...
<body style="font-family: system-ui, -apple-system, Segoe UI, Roboto, Helvetica, Arial, sans-serif; background: #f8fafc; padding: 24px; margin: 0;">
  <div style="max-width: 600px; margin: 0 auto; background: white; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
    ...
    <div style="background: ${HEADER_GRADIENT}; padding: 32px 24px; text-align: center;">
      ...
      <h1 style="color: white; margin: 0; font-size: 24px; font-weight: 700; line-height: 1.3;">¡Has sido invitado/a!</h1>
    </div>
    ...
    <div style="padding: 32px 24px; color: #334155; font-size: 16px; line-height: 1.6;">
      ...
      <p style="margin: 0 0 24px;">
        Te invitamos a participar en uno de nuestros próximos operativos. Tu experiencia y compromiso 
        serían de gran valor para esta misión.
      </p>
      ...
      <div style="background: #f1f5f9; border-radius: 12px; padding: 20px; margin-bottom: 24px;">
        ...
        <div style="display: flex; margin-bottom: 12px;">
          <span style="color: #64748b; width: 100px; flex-shrink: 0;">Ubicación:</span>
          <span style="color: #334155; font-weight: 500;">${operativo.ubicacion}</span>
        </div>
        <div style="display: flex; margin-bottom: 12px;">
          <span style="color: #64748b; width: 100px; flex-shrink: 0;">Inicio:</span>
          <span style="color: #334155; font-weight: 500;">${formatDate(operativo.fecha_inicio)}</span>
        </div>
        <div style="display: flex;">
          <span style="color: #64748b; width: 100px; flex-shrink: 0;">Término:</span>
          <span style="color: #334155; font-weight: 500;">${formatDate(operativo.fecha_fin)}</span>
        </div>
      </div>
      
      <p style="margin: 0 0 24px; color: #64748b; font-size: 14px;">
        Haz clic en el botón para confirmar o rechazar tu participación.
      </p>
      
      <!-- CTA Buttons -->
      <div style="text-align: center; margin-bottom: 16px;">
        <a href="${SITE_URL}/operativos/confirmar?token=${token}&respuesta=aceptar" 
           style="display: inline-block; background: linear-gradient(135deg, #16a34a, #22c55e); color: white; text-decoration: none; padding: 14px 32px; border-radius: 8px; font-weight: 600; font-size: 16px; margin-right: 12px; margin-bottom: 8px;">
          ✓ Aceptar
        </a>
        <a href="${SITE_URL}/operativos/confirmar?token=${token}&respuesta=rechazar" 
           style="display: inline-block; background: #e2e8f0; color: #475569; text-decoration: none; padding: 14px 32px; border-radius: 8px; font-weight: 600; font-size: 16px;">
          ✗ Rechazar
        </a>
      </div>
    </div>
    ...
    <div style={{ fontFamily: "system-ui, sans-serif", padding: "24px", background: "#1e293b", minHeight: "100vh" }}>
      <div style={{ maxWidth: "800px", margin: "0 auto" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "16px" }}>
          <h1 style={{ color: "white", fontSize: "18px", margin: 0 }}>Preview: Invitación a Operativo</h1>
